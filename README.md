...
```bash
curl -LO https://github.com/mijonOfTheMoon/superscaler/releases/download/2.1.3/superscaler-2.1.3-1.amzn2023.noarch.rpm
```

2. Install the package

```bash
sudo dnf install superscaler-2.1.3-1.amzn2023.noarch.rpm
```
...
```bash
curl -LO https://github.com/mijonOfTheMoon/superscaler/releases/download/2.1.3/superscaler_2.1.3-1_all.deb
```

2. Install the package

```bash
sudo dpkg -i superscaler_2.1.3-1_all.deb
```
