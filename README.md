...
```bash
curl -LO https://github.com/mijonOfTheMoon/superscaler/releases/download/2.2.0/superscaler-2.2.0-1.amzn2023.noarch.rpm
```

2. Install the package

```bash
sudo dnf install superscaler-2.2.0-1.amzn2023.noarch.rpm
```
...
```bash
curl -LO https://github.com/mijonOfTheMoon/superscaler/releases/download/2.2.0/superscaler_2.2.0-1_all.deb
```

2. Install the package

```bash
sudo dpkg -i superscaler_2.2.0-1_all.deb
```
